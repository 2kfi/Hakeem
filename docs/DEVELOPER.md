...
| **LLM** | MedGemma (fine-tuned) via llama.cpp | Process queries with medical knowledge |
...
| **النموذج اللغوي** | MedGemma (معدّل) عبر llama.cpp | معالجة الاستفسارات بالمعرفة الطبية |
...
- **بدStreaming**: `/process-audio` - إرجاع ملف صوتي كامل
